...
<body>
    <div class="container">
        ...
        <form method="post"
            action="Tiempo_Total_De_Experiencia.php?entidad=<?php echo urlencode($entidad); ?>&numeroDocumento=<?php echo urlencode($numeroDocumento); ?>">
            <div class="row">
                <div class="col-sm-1"></div>
                <div class="col-sm-11">
            ...
            <div class="row">
                <div class="col-sm-1"></div>
                <div class="col-sm-6"><strong>Ocupación</strong></div>
                <div class="col-3">
                    <strong>Tiempo de experiencia</strong>
                </div>
                <div class="row">
                    <div class="col-7"></div>
                    <div class="col-2">Años</div>
    ...
    <div class="container mt-4">
        ...
        <div class="row mt-3">
            ...
            <div class="col-2">
                <input type="number" class="form-control" name="totalAnios" id="totalAnios" style="width: 100px"
                    readonly value="<?php echo $existingData['total_anios'] ?? '0'; ?>">
            </div>
            <div class="col-3">
                <input type="number" class="form-control" name="totalMeses" id="totalMeses" style="width: 100px"
                    readonly value="<?php echo $existingData['total_meses'] ?? '0'; ?>">
            </div>
        </div>
